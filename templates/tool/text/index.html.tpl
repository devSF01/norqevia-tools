...
<body>
  ...
  <main class="page">
    ...
    <aside class="privacy-note" aria-label="ローカル処理について"><span aria-hidden="true">●</span><div><strong>ブラウザ内で処理します</strong>入力したテキストはサーバーへ送信・保存されません。</div></aside>
    ...
    <section class="content-section"><h2>使い方</h2><ol><li>Tool固有の入力を準備します。</li><li>このScaffoldのtool-shellへ入力UIを実装します。</li><li>処理結果を確認します。</li><li>必要に応じてコピーまたは新しいファイルとして保存します。</li></ol></section>
    <section class="content-section"><h2>利用例</h2><div class="example">TOOL_SCAFFOLD_TODO: Tool固有の入力例と出力例を追加してください。</div></section>
    <section class="content-section"><h2>仕様・制限</h2><p>TOOL_SCAFFOLD_TODO: Tool固有の処理仕様、入力形式、制限、元データを変更しない方針を記載してください。</p></section>
    ...
    <section class="content-section"><h2>関連ツール</h2><p><a href="/text/list-compare/">2つのリスト突合</a> / <a href="/csv/columns/">CSV列抽出・列削除</a></p></section>
  </main>
